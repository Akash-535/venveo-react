...
const ReadyToHit = () => {
  return (
    ...
    <div className='max-w-[1140px] mx-auto text-center flex py-[66px] gap-9 justify-center md:items-center max-lg:flex-col max-md:py-14 max-md:gap-7'>
        ...
        <button className='p-[31px] flex items-center justify-center gap-2.5 bg-lemon-lime text-[15px] font-semibold font-maisonMedium transition-all duration-300 ease-linear button-arrow'>Book a Strategy Call 
            <ButtonArrow/>
        </button>
    </div>
</div>
